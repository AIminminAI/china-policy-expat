// 完整政策数据（含详情字段）- 从 api/policy-detail.ts 提取
// 供前端计算器与政策详情页共享使用，所有内容免费开放
...
export const policyCategories: Record<string, string> = {
  tax: "Tax & Finance",
...
export const policies: Policy[] = [
  ...
  },
  {
    ...
    source: "Ministry of Science and Technology; Local Innovation Zones",
